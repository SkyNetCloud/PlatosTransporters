...
public class ScreenEffectRenderer {
   ...
   public static void renderScreenEffect(Minecraft p_110719_, PoseStack p_110720_) {
      ...
      if (!player.noPhysics) {
         ...
         if (overlay != null) {
            if (!net.minecraftforge.client.ForgeHooksClient.renderBlockOverlay(player, p_110720_, net.minecraftforge.client.event.RenderBlockOverlayEvent.OverlayType.BLOCK, overlay.getLeft(), overlay.getRight()))
